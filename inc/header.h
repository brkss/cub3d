...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/19 23:44:02 by adriouic          #+#    #+#             */
/*   Updated: 2022/12/19 23:44:03 by adriouic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		get_dist_x_y(double *dist_x_y,
				t_param *p, t_vector *delta, t_vector *step);
/*------------------- Main -------------------------*/
